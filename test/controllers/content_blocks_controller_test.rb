...
class ContentBlocksControllerTest < ActionController::TestCase
  ...
  test "should create content_block" do
    assert_difference('ContentBlock.count') do
      post :create, content_block: { content: @content_block.content, contentType_id: @content_block.contentType_id, style_id: @content_block.style_id }
    end
  ...
  test "should update content_block" do
    patch :update, id: @content_block, content_block: { content: @content_block.content, contentType_id: @content_block.contentType_id, style_id: @content_block.style_id }
    assert_redirected_to content_block_path(assigns(:content_block))
  end
